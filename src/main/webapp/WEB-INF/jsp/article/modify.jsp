...
<form class="table-box con form1" method="POST" action="${board.code}-doModify" onsubmit="ArticleModifyForm__submit(this); return false;">
	...
	<table>
		<tbody>
			...
			<tr>
				...
				<td>
					<div class="form-control-box">
						<label><input type="checkbox" name="deleteFile__article__${article.id}__common__attachment__2" value="Y" /> 삭제 </label>
					</div>
				</td>
			</tr>
		</tbody>
